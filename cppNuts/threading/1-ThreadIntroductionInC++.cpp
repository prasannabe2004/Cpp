...
// ANSWER
// 0. In evey application there is a default thread which is main(), in side
// this we create other threads.
// 1. A thread is also known as lightweight process. Idea is achieve parallelism
...
//    another thread to process inputs (spell checker) (c) Visual Studio code
//    editor would be using threading for auto completing the code.
//    (Intellicence)
...
// REQUIREMENT
// Find the addition of all odd number from 1 to 1900000000 and all even number
// from 1 to 1900000000
...
int main() {
    ...
    cout << "With Threading - Sec: " << duration.count() / 1000000 << endl;
    ...
    cout << "OddSum : " << OddSum << endl;
    cout << "EvenSum : " << EvenSum << endl;
    cout << "Without Threading - Sec: " << duration.count() / 1000000 << endl;
    return 0;
}