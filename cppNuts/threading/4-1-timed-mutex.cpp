...
// NOTES:
// 0. std::timed_mutex is blocked till timeout_time or the lock is aquired and
...
//  Waits until specified timeout_duration has elapsed or the lock is acquired,
...
// Waits until specified timeout_time has been reached or the lock is acquired,
// whichever comes first. On successful lock acquisition returns true, otherwise
// returns false.
